# Angular Dropdown Multiselect for Bootstrap CSS 
...
* Install with [npm](https://www.npmjs.com): `npm install ngx-dropdown-multiselect --save`.
...
```html
<ngx-dropdown-multiselect [options]="myOptions" [(ngModel)]="optionsModel" (ngModelChange)="onChange($event)"></ngx-dropdown-multiselect>
```
...
```html
<ngx-dropdown-multiselect [options]="myOptions" [texts]="myTexts" [settings]="mySettings" [(ngModel)]="optionsModel"></ngx-dropdown-multiselect>
```
### Settings
...
<form [formGroup]="myForm">
    <ngx-dropdown-multiselect [options]="myOptions" formControlName="optionsModel"></ngx-dropdown-multiselect>
</form>
```
